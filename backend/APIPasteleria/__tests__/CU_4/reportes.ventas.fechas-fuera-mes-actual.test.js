...
describe("CU4 - Reportes", () => {
  it("CU4-CP15 Fechas fuera del mes actual - No se genera reporte", async () => {
    // Rango deliberadamente fuera del mes actual (muy futuro) para asegurar que no haya ventas
    // y el sistema NO genere PDF.
    ...
    // Esto valida que no hay archivo PDF descargable.
